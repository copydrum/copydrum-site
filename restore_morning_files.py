...
def find_morning_files():
    """11월 10일 오전 1시 이전 파일 찾기"""
...
def main():
    print("=" * 70)
    print("11월 10일 오전 1시 이전 파일 복구")
    print("=" * 70)
    
    found_files = find_morning_files()
    
    if not found_files:
        print("\n[오류] 11월 10일 오전 1시 이전 파일을 찾을 수 없습니다.")
        print("\n다른 시간대도 확인해볼까요? (예: 오전 2시 이전, 오전 3시 이전 등)")
        return
