  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="md:hidden">
        {/* 모바일 장르 탭 - 헤더 바로 아래 */}
        {/* 수정됨: 한국어(ko)일 때 헤더 높이에 맞춰 top 값을 170px로 늘림 (영어는 76px 유지) */}
        <div className={`sticky ${i18n.language === 'ko' ? 'top-[170px]' : 'top-[76px]'} z-40 bg-white border-b border-gray-200 overflow-x-auto`}>
